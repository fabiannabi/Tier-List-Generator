...
var imageItem = document.querySelectorAll(".character-select");
var boxes = document.querySelectorAll(".tier-list-open-space");
var currentDraggedItem = null; //recorrer para cada item en la NodeList que se crea con el query

var _loop = function _loop(i) {
  var item = imageItem[i];
  item.addEventListener("dragstart", function () {
    currentDraggedItem = item; //para que cuando lo empecemos a arrastrar desaparezca de el div
...
var originalbox = document.querySelector(".pool");
